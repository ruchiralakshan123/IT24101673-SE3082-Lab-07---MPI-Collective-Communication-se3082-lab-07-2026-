...
int main(int argc, char **argv) {
    ...
    /*
     * SCATTER: Root distributes one chunk of size chunk_size to each process.
     * sendcount is elements per process (NOT total array size).
     * After this call, local_chunk[0..chunk_size) holds each process's data.
     */
